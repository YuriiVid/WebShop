...
public class GoodsServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// String lorem = "Lorem Ipsum is simply dummy text of the printing and
		...
		ArrayList<Good> goods = goodRepository.getAllGoods();
		...
		String body = goods.stream().map(good -> {
			return "<div class=\"col-12 col-sm-6 col-lg-4 col-xl-3 my-2\">" +
					...
					"    <h6 class=\"card-subtitle mb-2 text-body-secondary\">" + "Ціна: "
					+ priceRepository.getPriceForGood(good.getId()).getFor_client() + "грн</h6>\n" +
