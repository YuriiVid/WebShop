...
public class StartServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (firebase.getUserByEmail(user.getEmail()) != null) {
			// TODO YuriiVid: login user
	...
	public void init() throws ServletException {
		...
		firebase.setFirebaseConfigPath(firebaseConfig[0]);
		firebase.setFirebaseName(firebaseConfig[1]);
		firebase.init();
	}
